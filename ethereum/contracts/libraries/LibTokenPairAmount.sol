...
library LibTokenPairAmountTracker {
    ...
    function changeAmounts(
        ...
        self.tokenPairAmounts[_tokenPairId].amount0 = _add(self.tokenPairAmounts[_tokenPairId].amount0, _amount0);
        self.tokenPairAmounts[_tokenPairId].amount1 = _add(self.tokenPairAmounts[_tokenPairId].amount1, _amount1);
    }
    ...
    function changeAmounts(
        ...
        self.tokenPairAmounts[_tokenPairId].amount0 = _addI128(self.tokenPairAmounts[_tokenPairId].amount0, _amount0);
        self.tokenPairAmounts[_tokenPairId].amount1 = _addI128(self.tokenPairAmounts[_tokenPairId].amount1, _amount1);
    }
