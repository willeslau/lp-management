...
//         uint256 amount1
//     );
//     event InjectedPriciple(uint8 tokenPair, uint256 amount0, uint256 amount1);
...
//         reserves.changeAmounts(
//             _tokenPairId,
//             _safeCastUintToInt(_amount0),
//             _safeCastUintToInt(_amount1)
//         );
//     }
...
//         (uint256 reserve0, uint256 reserve1) = reserves.getAmounts(
//             tokenPair.id
//         );
...
//                 amount1Min: 0
//             });
//             params.amount0Min = LibPercentageMath.deductRate(
//                 params.amount0Desired,
//                 _params.maxMintSlippageRate
//             );
//             params.amount1Min = LibPercentageMath.deductRate(
...
//         uint8 _tokenPairId
//     ) external onlyLiquidityOwner onlyDeactivated {
//         TokenPair memory tokenPair = _ensureValidTokenPair(_tokenPairId);
//         _withdraw(tokenPair);
//     }
